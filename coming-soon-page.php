        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox" id="csp_is_active" name="csp_is_active" value="1" <?php checked(1, get_option('csp_is_active', 0)); ?> />
                    </td>
                </tr>
                    ...
                    <td>
                        <select name="csp_page_ids[]" multiple>
                            <?php foreach ($pages as $page): ?>
                                <option value="<?php echo $page->ID; ?>" <?php echo in_array($page->ID, $page_ids) ? 'selected' : ''; ?>>
                ...
                <tr valign="top" class="csp-settings-options" <?php if (!$is_active) echo 'style="display:none;"'; ?>>
                    ...
                    <td>
                        <?php foreach ($users as $user): ?>
                            <label>
                                <input type="checkbox" name="csp_allowed_users[]" value="<?php echo $user->ID; ?>" <?php echo in_array($user->ID, $allowed_users) ? 'checked' : ''; ?>>
